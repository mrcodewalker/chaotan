/**
 * BUILD-RICH-SLIDES.CJS
 * Tạo dựng dữ liệu 40 slide chuẩn mực, loại bỏ toàn bộ visual: flow/chart,
 * gắn ảnh thực tế 100% cho từng slide, khắc phục slide 12 và làm giàu nội dung học thuật cho KMA.
 */
...
const SLIDES = [
  // =========================================================================
  // CHƯƠNG 1: ỨNG DỤNG AI TRONG HỌC TẬP (SLIDES 1 - 23)
  // =========================================================================
  {
    id: 1,
    sectionId: 1,
  ...
  // =========================================================================
  // CHƯƠNG 2: ỨNG DỤNG AI TRONG NGHIÊN CỨU KHOA HỌC (SLIDES 24 - 40)
  // =========================================================================
  {
    id: 24,
    sectionId: 2,
...
const SLIDES_DATA = ${JSON.stringify(SLIDES, null, 2)};
...
const targetPath = path.resolve(__dirname, '..', 'js', 'slides-data.js');
fs.writeFileSync(targetPath, fileContent, 'utf8');
console.log('Successfully wrote', SLIDES.length, 'slides to', targetPath);
